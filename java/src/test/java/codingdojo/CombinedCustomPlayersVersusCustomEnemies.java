...
public enum CombinedCustomPlayersVersusCustomEnemies implements TestCase {
    ...
    FIVE_EXCALIBUR_VS_INCREDIBLE_ARMOR(PLAYER_WITH_FIVE_EXCALIBUR, ENEMY_WITH_INCREDIBLE_ARMOR_CAUSE_NO_DAMAGE, 0),
    FIVE_EXCALIBUR_AND_GREAT_STATS_VS_INCREDIBLE_ARMOR(PLAYER_WITH_FIVE_EXCALIBUR_AND_GREAT_STATS, ENEMY_WITH_INCREDIBLE_ARMOR_CAUSE_NO_DAMAGE, 0),
    INCREDIBLE_STATS_VS_INCREDIBLE_ARMOR(PLAYER_WITH_INCREDIBLE_STATS, ENEMY_WITH_INCREDIBLE_ARMOR_CAUSE_NO_DAMAGE, 112),
